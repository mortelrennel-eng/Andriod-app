...
public class StudentDashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnEditProfile).setOnClickListener(v -> startActivity(new Intent(this, EditStudentProfileActivity.class)));
        findViewById(R.id.btnViewAnnouncements).setOnClickListener(v -> startActivity(new Intent(this, ViewAnnouncementsActivity.class)));
        findViewById(R.id.btnViewAttendance).setOnClickListener(v -> startActivity(new Intent(this, AttendanceHistoryActivity.class)));
        findViewById(R.id.btnOpenEbooks).setOnClickListener(v -> startActivity(new Intent(this, EbookListActivity.class)));
        findViewById(R.id.btnSavedEbooks).setOnClickListener(v -> startActivity(new Intent(this, SavedEbooksActivity.class)));
